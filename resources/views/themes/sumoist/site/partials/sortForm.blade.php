<div class="ph3-l ph2">
    ...
    <form class="mb2 mt1 pt3 mt2-ml pt4-ml " method="post" action="#products" id="sort_form" style="width: 313px">
        @csrf
        <div class="w-100  bg-transparent ba b--dark-red br2 pointer f6 h40 pl3 pr3 relative ease-in-fast flex items-center nested-list-reset select"
            ...
            <ul class="ease-in-fast scale0 o-0 top-100 ba b--dark-red br2 list shadow-2 bg-black mt1 pv1 o-100 overflow-hidden absolute z-999 left-0 right-0" style="max-height:300px">
