...
<div class="flex flex-shrink-0"  @isset($is_second_popup) data-layerok="#show-sign-modal_2" @else data-layerok="#show-sign-modal" @endisset>
    ...
    <div class="nested-img pointer " >
        <img src="{{ Asset::load('img/cart.svg') }}" alt="Корзина">
    </div>
    ...
    <div class="ba b--white absolute bg-dark-red white br-pill ph2 pv1 right-0" style="top:2px"><span data-cart-total-quantity>{{ Cart::getTotalQuantity() }} </span></div>
